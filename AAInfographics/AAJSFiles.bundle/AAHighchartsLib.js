            ...
            drawTrackerPoint: function() {
                var a = this,
                    ...
                    d = function(a) {
                        ...
                        void 0 !== b && (c.isDirectTouch = !0, b.onMouseOver(a), console.log("mouseOver 8990"))
                    };
            ...
            setItemEvents: function(a, c, e) {
                ...
                (e ? c : a.legendGroup).on("mouseover", function() {
                    ...
                    a.firePointEvent ? a.firePointEvent("legendItemClick", b, c) : u(a, "legendItemClick", b, c)
                      configureSeriesTouchEvent(a.legendItem.textStr, a.visible);
                      console.log(">>>>> Item Clicked for Legend")
                      console.log(a.legendItem.textStr)
