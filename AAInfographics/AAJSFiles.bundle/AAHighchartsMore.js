...
*/
(function(r) {
    "object" === typeof module && module.exports ? (r["default"] = r, module.exports = r) : "function" === typeof define && define.amd ? define("highcharts/highcharts-more", ["highcharts"], function(y) {
        r(y);
        r.Highcharts = y;
        return r
    ...
    function y(a, p, l, e) {
        a.hasOwnProperty(p) || (a[p] = e.apply(null, l))
    }
    r = r ? r._modules : {};
    y(r, "parts-more/Pane.js", [r["parts/Globals.js"]], function(a) {
        ...
        e(p.prototype, {
            ...
            render: function() {
                ...
                this.updateCenter();
                if (f)
                    for (f = b(f), a = Math.max(f.length, this.background.length || 0), c = 0; c < a; c++) f[c] &&
            ...
            updateCenter: function(b) {
                this.center = (b || this.axis || {}).center = l.getCenter.call(this)
            },
            update: function(b, f) {
                h(!0, this.options, b);
                ...
                this.chart.axes.forEach(function(b) {
                    b.pane === this && (b.pane = null, b.update({}, f))
                }, this)
            }
        });
        a.Pane = p
    ...
    y(r, "parts-more/RadialAxis.js", [r["parts/Globals.js"]], function(a) {
        ...
        d = {
            ...
            getOffset: function() {
                q.getOffset.call(this);
                this.chart.axisOffset[this.side] = 0
            },
            getLinePath: function(d, b) {
                d = this.center;
                var k = this.chart,
                    m = g(b, d[2] / 2 - this.offset);
                this.isCircular || void 0 !== b ? (b = this.chart.renderer.symbols.arc(this.left + d[0], this.top + d[1], m, m, {
                    start: this.startAngleRad,
                    end: this.endAngleRad,
                    open: !0,
                    innerR: 0
                }), b.xBounds = [this.left + d[0]], b.yBounds = [this.top +
                    d[1] - m
                ]) : (b = this.postTranslate(this.angleRad, m), b = ["M", d[0] + k.plotLeft, d[1] + k.plotTop, "L", b.x, b.y]);
                return b
            },
            setAxisTranslation: function() {
                q.setAxisTranslation.call(this);
            ...
            getPosition: function(d, b) {
                return this.postTranslate(this.isCircular ? this.translate(d) : this.angleRad, g(this.isCircular ? b : this.translate(d), this.center[2] / 2) - this.offset)
            },
            postTranslate: function(d, b) {
                var k = this.chart,
                    m = this.center;
                d = this.startAngleRad + d;
                return {
                    x: k.plotLeft + m[0] + Math.cos(d) * b,
                    y: k.plotTop + m[1] + Math.sin(d) * b
                }
            },
            getPlotBandPath: function(d, b, k) {
                var m = this.center,
                    q = this.startAngleRad,
                    n = m[2] / 2,
                    u = [g(k.outerRadius, "100%"), k.innerRadius, g(k.thickness, 10)],
                ...
                "polygon" === this.options.gridLineInterpolation ? u = this.getPlotLinePath(d).concat(this.getPlotLinePath(b, !0)) : (d = Math.max(d, this.min), b = Math.min(b, this.max),
                    a || (u[0] = this.translate(d), u[1] = this.translate(b)), u = u.map(function(d) {
                        c.test(d) && (d = f(d, 10) * n / 100);
                        return d
                    }), "circle" !== k.shape && a ? (d = q + this.translate(d), b = q + this.translate(b)) : (d = -Math.PI / 2, b = 1.5 * Math.PI, w = !0), u[0] -= v, u[2] -= v, u = this.chart.renderer.symbols.arc(this.left + m[0], this.top + m[1], u[0], u[0], {
                        start: Math.min(d, b),
                        end: Math.max(d, b),
                        innerR: g(u[1], u[0] - u[2]),
                        open: w
                    }), a && (a = (b + d) / 2, v = this.left + m[0] + m[2] / 2 * Math.cos(a), u.xBounds = a > -Math.PI / 2 && a < Math.PI / 2 ? [v, this.chart.plotWidth] : [0, v], u.yBounds = [this.top + m[1] + m[2] / 2 * Math.sin(a)], u.yBounds[0] += a > -Math.PI && 0 > a || a > Math.PI ? -10 : 10));
                return u
            },
            getPlotLinePath: function(d, b) {
                var k = this,
                    ...
                    n = k.getPosition(d),
                    u, v, a;
                k.isCircular ? a = ["M", m[0] + q.plotLeft, m[1] + q.plotTop, "L", n.x, n.y] : "circle" === k.options.gridLineInterpolation ? (d = k.translate(d), a = k.getLinePath(0, d)) : (q.xAxis.forEach(function(d) {
                    d.pane === k.pane && (u = d)
                }), a = [], d = k.translate(d), m = u.tickPositions, u.autoConnect && (m = m.concat([m[0]])), b && (m = [].concat(m).reverse()), m.forEach(function(k,
                    m) {
                    v = u.getPosition(k, d);
                    a.push(m ? "L" : "M", v.x, v.y)
                }));
                return a
            },
        ...
        p(l, "init", function(b) {
            ...
            if (m) {
                if (e(this, a ? x : d), c = !u) this.defaultRadialOptions = this.defaultRadialGaugeOptions
            } else n && (e(this,
                d), this.defaultRadialOptions = (c = u) ? this.defaultRadialXOptions : h(this.defaultYAxisOptions, this.defaultRadialYOptions));
            m || n ? (this.isRadial = !0, k.inverted = !1, f.chart.zoomType = null, k.labelCollectors.push(function() {
                if (q.isRadial && q.tickPositions && !0 !== q.options.labels.allowOverlap) return q.tickPositions.map(function(d) {
                    return q.ticks[d] && q.ticks[d].label
                }).filter(function(d) {
                    return !!d
                })
            })) : this.isRadial = !1;
        ...
        p(l, "autoLabelAlign", function(d) {
            this.isRadial && (d.align = void 0, d.preventDefault())
        });
        p(c, "afterGetPosition", function(d) {
            this.axis.getPosition && e(d.pos, this.axis.getPosition(this.pos))
        });
        p(c, "afterGetLabelPosition", function(d) {
            var b = this.axis,
                ...
                n, u = 20,
                a = m.align,
                c = (b.translate(this.pos) + b.startAngleRad + Math.PI / 2) / Math.PI * 180 % 360;
            b.isRadial && (n = b.getPosition(this.pos, b.center[2] / 2 + g(m.distance, -25)), "auto" === m.rotation ? k.attr({
                    rotation: c
                }) : null === q && (q = b.chart.renderer.fontMetrics(k.styles && k.styles.fontSize).b - k.getBBox().height / 2), null === a && (b.isCircular ? (this.label.getBBox().width > b.len * b.tickInterval / (b.max - b.min) && (u = 0), a = c > u && c < 180 - u ? "left" : c > 180 + u && c < 360 - u ? "right" : "center") : a = "center", k.attr({
                    align: a
                })),
                d.pos.x = n.x + m.x, d.pos.y = n.y + q)
        });
        t(n, "getMarkPath", function(d, b, k, m, q, n, a) {
            var u = this.axis;
            u.isRadial ? (d = u.getPosition(this.pos, u.center[2] / 2 + m), b = ["M", b, k, "L", d.x, d.y]) : b = d.call(this, b, k, m, q, n, a);
            return b
        })
    });
    y(r, "parts-more/AreaRangeSeries.js", [r["parts/Globals.js"]], function(a) {
        ...
        b("arearange", "area", {
            ...
            highToXY: function(b) {
                var a = this.chart,
                    c = this.xAxis.postTranslate(b.rectPlotX, this.yAxis.len - b.plotHigh);
                b.plotHighX = c.x - a.plotLeft;
                b.plotHigh = c.y - a.plotTop;
                b.plotLowX = b.plotX
            },
            translate: function() {
                var b = this,
            ...
            getGraphPath: function(b) {
                var a = [],
                    c = [],
                    d, q = g.area.prototype.getGraphPath,
                    n, u, v;
                v = this.options;
                var k = this.chart.polar && !1 !== v.connectEnds,
                    m = v.connectNulls,
                    f = v.step;
                b = b || this.points;
                for (d = b.length; d--;) n =
                    b[d], n.isNull || k || m || b[d + 1] && !b[d + 1].isNull || c.push({
                        plotX: n.plotX,
                        plotY: n.plotY,
                        doCurve: !1
                    }), u = {
                        ...
                        yBottom: n.yBottom,
                        plotX: p(n.plotHighX, n.plotX),
                        plotY: n.plotHigh,
                        isNull: n.isNull
                    }, c.push(u), a.push(u), n.isNull || k || m || b[d - 1] && !b[d - 1].isNull || c.push({
                        plotX: n.plotX,
                        plotY: n.plotY,
                        doCurve: !1
                    });
            ...
            drawDataLabels: function() {
                var b = this.points,
                    a = b.length,
                    c, d = [],
                    q = this.options.dataLabels,
                    n, u, v = this.chart.inverted,
                    k, m;
                e(q) ? 1 < q.length ? (k = q[0], m = q[1]) : (k = q[0], m = {
                    enabled: !1
                }) : (k = l({}, q), k.x = q.xHigh, k.y = q.yHigh, m = l({}, q), m.x = q.xLow, m.y = q.yLow);
                if (k.enabled || this._hasPointLabels) {
                    for (c = a; c--;)
                        if (n = b[c]) u = k.inside ? n.plotHigh < n.plotLow : n.plotHigh > n.plotLow, n.y = n.high, n._plotY =
                    ...
                    for (c = a; c--;)
                        if (n = b[c]) n.dataLabelUpper = n.dataLabel, n.dataLabel = d[c], delete n.dataLabels, n.y = n.low, n.plotY = n._plotY
                }
                if (m.enabled || this._hasPointLabels) {
                    for (c = a; c--;)
                        if (n = b[c]) u = m.inside ? n.plotHigh < n.plotLow : n.plotHigh > n.plotLow, n.below = !u, v ? m.align ||
                ...
                if (k.enabled)
                    for (c = a; c--;)
                        if (n = b[c]) n.dataLabels = [n.dataLabelUpper, n.dataLabel].filter(function(d) {
                            return !!d
                        });
            ...
            drawPoints: function() {
                ...
                for (e = 0; e < b;) c = this.points[e], c.origProps = {
                    plotY: c.plotY,
                    plotX: c.plotX,
                    isInside: c.isInside,
                    negative: c.negative,
                ...
                f.drawPoints.apply(this, arguments);
                for (e = 0; e < b;) c = this.points[e], c.upperGraphic =
    ...
    y(r, "parts-more/AreaSplineRangeSeries.js", [r["parts/Globals.js"]], function(a) {
        var p = a.seriesType;
    ...
    y(r, "parts-more/ColumnRangeSeries.js", [r["parts/Globals.js"]], function(a) {
        ...
        b("columnrange", "arearange", l(p.column, p.arearange, {
            pointRange: null,
            marker: null,
            states: {
                hover: {
            ...
            translate: function() {
                var b = this,
                    ...
                    p, d = b.chart,
                    q = b.xAxis.isRadial,
                    n = Math.max(d.chartWidth, d.chartHeight) + 999,
                    u;
                g.translate.apply(b);
                b.points.forEach(function(v) {
                    ...
                    q ? (p = v.barX + e, v.shapeType = "path", v.shapeArgs = {
                        d: b.polarArc(g + f, g, p, p + v.pointWidth)
                    }) : (k.height = f, k.y = g, v.tooltipPos = d.inverted ? [c.len + c.pos - d.plotLeft - g - f / 2, a.len + a.pos - d.plotTop - k.x - k.width / 2, f] : [a.left - d.plotLeft + k.x + k.width / 2, c.pos - d.plotTop + g + f / 2, f])
                })
            },
            directTouch: !0,
            trackerGroups: ["group",
    ...
    y(r, "parts-more/ColumnPyramidSeries.js", [r["parts/Globals.js"]], function(a) {
        var p = a.pick,
            l = a.seriesType,
            e = a.seriesTypes.column.prototype;
        l("columnpyramid", "column", {}, {
            translate: function() {
                var a = this,
                    ...
                    f = a.borderWidth = p(g.borderWidth,
                        f ? 0 : 1),
                    c = a.yAxis,
                    l = g.threshold,
                    w = a.translatedThreshold = c.getThreshold(l),
                    x = p(g.minPointLength, 5),
                    d = a.getColumnMetrics(),
                    q = d.width,
                    n = a.barW = Math.max(q, 1 + 2 * f),
                    u = a.pointXOffset = d.offset;
                b.inverted && (w -= .5);
                ...
                a.points.forEach(function(d) {
                    var k = p(d.yBottom, w),
                        m = 999 + Math.abs(k),
                        f = Math.min(Math.max(-m, d.plotY), c.len + m),
                        m = d.plotX + u,
                        e = n / 2,
                        v = Math.min(f, k),
                        k = Math.max(f, k) - v,
            ...
            g("gauge", "line", {
                ...
                translate: function() {
                    ...
                    this.points.forEach(function(c) {
                        var d = l(a.dial, c.dial),
                            q = h(e(d.radius, 80)) * f[2] / 200,
                            n = h(e(d.baseLength, 70)) * q / 100,
                        ...
                        c.shapeArgs = {
                            d: d.path || ["M", -u, -v / 2, "L",
                                n, -v / 2, q, -k / 2, q, k / 2, n, v / 2, -u, v / 2, "z"
                            ],
                            translateX: f[0],
                            translateY: f[1],
                            rotation: g
                ...
                drawPoints: function() {
                    ...
                    b.points.forEach(function(q) {
                        var c = q.graphic,
                            ...
                            m = k.d,
                            f = l(d.dial, q.dial);
                        c ? (c.animate(k), k.d = m) : (q.graphic = n[q.shapeType](k).attr({
                            rotation: k.rotation,
                            zIndex: 1
                        }).addClass("highcharts-dial").add(b.group), a.styledMode || q.graphic.attr({
    ...
    y(r,
        "parts-more/BoxPlotSeries.js", [r["parts/Globals.js"]],
        function(a) {
            var p = a.noop,
                l = a.pick,
                e = a.seriesType,
            ...
            e("boxplot", "column", {
                ...
                drawPoints: function() {
                    var b = this,
                        ...
                        e, h, p, d, q, n,
                        u = 0,
                        v, k, m, I, E = !1 !== b.doQuartiles,
                        F, D = b.options.whiskerLength;
                    b.points.forEach(function(g) {
                        ...
                        void 0 !== g.plotY && (v = w.width, k = Math.floor(w.x), m = k + v, I = Math.round(v / 2), e = Math.floor(E ? g.q1Plot : g.lowPlot), h = Math.floor(E ? g.q3Plot : g.lowPlot), p = Math.floor(g.highPlot), d = Math.floor(g.lowPlot), t || (g.graphic = t = c.g("point").add(b.group), g.stem = c.path().addClass("highcharts-boxplot-stem").add(t), D && (g.whiskers = c.path().addClass("highcharts-boxplot-whisker").add(t)),
                            ...
                            G, x["stroke-width"] = a.lineWidth || 0, g.box.attr(x)), y.stroke = g.medianColor || a.medianColor || G, y["stroke-width"] = l(g.medianWidth, a.medianWidth, a.lineWidth), g.medianShape.attr(y)), n = g.stem.strokeWidth() % 2 / 2, u = k + I + n, g.stem[B]({
                            d: ["M", u, h, "L", u, p, "M", u, e, "L", u, d]
                        }), E && (n = g.box.strokeWidth() % 2 / 2, e = Math.floor(e) + n, h = Math.floor(h) + n, k += n, m += n, g.box[B]({
                            d: ["M", k, h, "L", k, e, "L", m, e, "L", m, h, "L", k, h, "z"]
                        })), D && (n = g.whiskers.strokeWidth() % 2 / 2, p += n, d += n, F = /%$/.test(D) ? I * parseFloat(D) / 100 : D / 2, g.whiskers[B]({
                            d: ["M",
                                u - F, p, "L", u + F, p, "M", u - F, d, "L", u + F, d
                            ]
                        })), q = Math.round(g.medianPlot), n = g.medianShape.strokeWidth() % 2 / 2, q += n, g.medianShape[B]({
                            d: ["M", k, q, "L", m, q]
                        }))
                    })
                },
    ...
    y(r, "parts-more/WaterfallSeries.js", [r["parts/Globals.js"]], function(a) {
        var p =
            ...
            x = a.seriesType,
            d = a.seriesTypes;
        f(a.Axis, "afterInit", function() {
            this.isXAxis || (this.waterfallStacks = {})
        });
        f(c, "beforeRedraw", function() {
            for (var b = this.axes, d = this.series, a = d.length; a--;) d[a].options.stacking && (b.forEach(function(b) {
                b.isXAxis || (b.waterfallStacks = {})
            }), a = 0)
        });
        x("waterfall", "column", {
            dataLabels: {
            ...
            generatePoints: function() {
                var b, a, c, f;
                d.column.prototype.generatePoints.apply(this);
                c = 0;
                for (a = this.points.length; c < a; c++)
                    if (b = this.points[c], f = this.processedYData[c], b.isIntermediateSum || b.isSum) b.y = p(f)
            },
            translate: function() {
                var b = this.options,
                    a = this.yAxis,
                    c, f, k, m, g, h, p, l, t, w = e(b.minPointLength, 5),
                    x = w / 2,
                    r = b.threshold,
                    C = b.stacking,
                    J = a.waterfallStacks[this.stackKey],
                    A;
            ...
            processData: function(b) {
                var d = this.options,
                    ...
                    q = d.threshold || 0,
                    f, g, e, h, t, l;
                for (l = g = f = e = h = 0; l < m; l++) t = a[l], k = c && c[l] ? c[l] : {}, "sum" === t || k.isSum ? a[l] = p(g) : "intermediateSum" === t || k.isIntermediateSum ? (a[l] = p(f),
            ...
            pointAttribs: function(b, a) {
                ...
                b = d.column.prototype.pointAttribs.call(this, b, a);
                delete b.dashstyle;
                return b
            },
            ...
            setStackedPoints: function() {
                ...
                if (this.visible || !this.chart.options.chart.ignoreHiddenSeries)
                    for (d[m] || (d[m] = {}), d = d[m], m = 0; m < g; m++) e = f[m], d[e] || (d[e] = {
                            negTotal: 0,
                            posTotal: 0,
                            total: 0,
                            stackTotal: 0,
            ...
            getExtremes: function() {
                ...
                d && (a = this.yAxis, a = a.waterfallStacks, c = this.stackedYNeg = [], f = this.stackedYPos = [], "overlap" === d ? h(a[this.stackKey], function(d) {
                    ...
                    c.push(b(k));
                    f.push(g(k))
                }) : h(a[this.stackKey], function(b) {
                    c.push(b.negTotal + b.threshold);
                    f.push(b.posTotal + b.threshold)
                }), this.dataMin = b(c), this.dataMax = g(f))
            }
        }, {
            getClassName: function() {
                var b = t.prototype.getClassName.call(this);
                this.isSum ? b += " highcharts-sum" : this.isIntermediateSum && (b += " highcharts-intermediate-sum");
                return b
            },
            isValid: function() {
                return l(this.y, !0) || this.isSum || this.isIntermediateSum
            }
        })
    });
    y(r, "parts-more/PolygonSeries.js", [r["parts/Globals.js"]], function(a) {
        ...
        l("polygon", "scatter", {
            ...
            type: "polygon",
            getGraphPath: function() {
                for (var a = p.prototype.getGraphPath.call(this), b = a.length + 1; b--;)(b === a.length || "M" === a[b]) && 0 < b && a.splice(b, 0, "z");
                return this.areaPath = a
            },
            drawGraph: function() {
                this.options.fillColor = this.color;
                e.area.prototype.drawGraph.call(this)
            },
    ...
    y(r, "parts-more/BubbleLegend.js", [r["parts/Globals.js"]], function(a) {
        ...
        a.BubbleLegend.prototype = {
            ...
            drawLegendSymbol: function(b) {
                var a = this.chart,
                    k = this.options,
                    c = d(b.options.itemDistance, 20),
                    e, g = k.ranges;
                e = k.connectorDistance;
                this.fontMetrics = a.renderer.fontMetrics(k.labels.style.fontSize.toString() + "px");
                g && g.length && f(g[0].value) ? (q(g, function(b, d) {
                        return d.value - b.value
                    }), this.ranges = g, this.setOptions(), this.render(), a = this.getMaxLabelSize(), g = this.ranges[0].radius, b = 2 * g, e = e - g + a.width, e = 0 < e ? e : 0, this.maxLabel = a, this.movementX = "left" === k.labels.align ? e : 0, this.legendItemWidth = b + e + c, this.legendItemHeight =
            ...
            setOptions: function() {
                var b = this.ranges,
                    ...
                    u = c.options.marker.fillOpacity,
                ...
                b.forEach(function(k, m) {
                    ...
                    b[m] = w(b[m], {
                        center: b[0].radius - b[m].radius + f
                    });
                    h || w(!0, b[m], {
                        bubbleStyle: w(!1, e),
                        connectorStyle: w(!1, q),
                        labelStyle: n
                    })
                }, this)
            },
            getLabelStyles: function() {
                ...
                t(b.labels.style, function(b, d) {
                    "color" !== d && "fontSize" !== d && "z-index" !== d && (a[d] = b)
                });
                return w(!1, a, {
                    "font-size": b.labels.style.fontSize,
                    fill: d(b.labels.style.color, "#000000"),
                    "z-index": b.zIndex,
                    align: f || c ? "right" : "left"
                })
            },
            ...
            renderRange: function(b) {
                var d = this.options,
                    ...
                    e = b.center,
                    q = Math.abs(b.radius),
                    g = d.connectorDistance,
                    n = a.align,
                    u = a.style.fontSize,
                    g = this.legend.options.rtl || "left" === n ? -g : g,
                    a = d.connectorWidth,
                    h = this.ranges[0].radius,
                    p = e - q - d.borderWidth / 2 + a / 2,
                    v, u = u / 2 - (this.fontMetrics.h -
                        u) / 2,
                    l = c.styledMode;
            ...
            hideOverlappingLabels: function() {
                var b = this.chart,
                    d = this.symbols;
                !this.options.labels.allowOverlap && d && (b.hideOverlappingLabels(d.labels), d.labels.forEach(function(b, a) {
                    b.newOpacity ? b.newOpacity !== b.oldOpacity && d.connectors[a].show() : d.connectors[a].hide()
                }))
            },
            getRanges: function() {
                var b = this.legend.bubbleLegend,
                    a, c = b.options.ranges,
            ...
            predictBubbleSizes: function() {
                var b = this.chart,
                    ...
                    f = c ? b.legend.lastLineHeight : 0,
                    e = b.plotSizeX,
                    q = b.plotSizeY,
                    g = b.series[this.options.seriesIndex],
                    b = Math.ceil(g.minPxSize),
                    n = Math.ceil(g.maxPxSize),
                    g = g.options.maxSize,
                    u = Math.min(q, e);
                if (a.floating || !/%$/.test(g)) d = n;
                else if (g = parseFloat(g), d = (u + f - d.h / 2) * g / 100 / (g / 100 + 1), c && q - d >= e || !c && e - d >= q) d = n;
                return [b, Math.ceil(d)]
            },
            updateRanges: function(b, d) {
        ...
        h(a.Legend, "afterGetAllItems", function(b) {
            ...
            0 <= f && c.enabled && k.enabled && (k.seriesIndex = f, this.bubbleLegend = new a.BubbleLegend(k, this), this.bubbleLegend.addToLegend(b.allItems))
        });
        e.prototype.getVisibleBubbleSeriesIndex = function() {
            for (var b =
                    this.series, d = 0; d < b.length;) {
        ...
        l.prototype.getLinesHeights = function() {
            ...
            for (f = 0; f < c; f++)
                if (b[f].legendItemHeight && (b[f].itemHeight = b[f].legendItemHeight), b[f] === b[c - 1] || b[f + 1] && b[f]._legendItemPos[1] !== b[f + 1]._legendItemPos[1]) {
                    ...
                    a = d[d.length - 1];
                    for (e; e <= f; e++) b[e].itemHeight > a.height && (a.height = b[e].itemHeight);
                    a.step = f
                } return d
        };
        l.prototype.retranslateItems = function(b) {
            var d,
                a, c, f = this.options.rtl,
                e = 0;
            this.allItems.forEach(function(k, g) {
                d = k.legendGroup.translateX;
                a = k._legendItemPos[1];
                if ((c = k.movementX) || f && k.ranges) c = f ? d - k.options.maxSize / 2 : d + c, k.legendGroup.attr({
                    translateX: c
                });
                g > b[e].step && e++;
                k.legendGroup.attr({
                    translateY: Math.round(a + b[e].height / 2)
                });
                k._legendItemPos[1] = a + b[e].height / 2
            })
        };
        h(p, "legendItemClick", function() {
          //console.log(">>>>>>>>>>> legendItemClick")
            ...
            a && a.bubbleLegend && (this.visible = !d, this.ignoreSeries = d, b = 0 <= b.getVisibleBubbleSeriesIndex(),
                a.bubbleLegend.visible !== b && (a.update({
                    bubbleLegend: {
                        enabled: b
                    }
                }), a.bubbleLegend.visible = b), this.visible = d)
          //console.log(">>>>>>>>>>> legendItemClick")
          //console.log(b)
          //console.log(d)
          //console.log(a)
        ...
        b(e.prototype, "drawChartBox", function(b, d, a) {
            var c = this.legend,
                ...
                e;
            c && c.options.enabled && c.bubbleLegend && c.options.bubbleLegend.autoRanges && f ? (e = c.bubbleLegend.options, f = c.bubbleLegend.predictBubbleSizes(), c.bubbleLegend.updateRanges(f[0], f[1]), e.placed || (c.group.placed = !1, c.allItems.forEach(function(b) {
                    b.legendGroup.translateY = null
                })), c.render(), this.getMargins(),
                this.axes.forEach(function(b) {
                    b.render();
                    e.placed || (b.setScale(), b.updateNames(), t(b.ticks, function(b) {
                        b.isNew = !0;
                        b.isNewLabel = !0
                    }))
                }), e.placed = !0, this.getMargins(), b.call(this, d, a), c.bubbleLegend.correctSizes(), c.retranslateItems(c.getLinesHeights())) : (b.call(this, d, a), c && c.options.enabled && c.bubbleLegend && (c.render(), c.retranslateItems(c.getLinesHeights())))
        })
    });
    y(r, "parts-more/BubbleSeries.js", [r["parts/Globals.js"]], function(a) {
        ...
        x("bubble", "scatter", {
            ...
            pointAttribs: function(b, d) {
                ...
                b = w.prototype.pointAttribs.call(this, b, d);
                1 !== a && (b.fill = h(b.fill).setOpacity(a).get("rgba"));
                return b
            },
            getRadii: function(b, d, a) {
                var c, f = this.zData,
                    e = a.minPxSize,
                    g = a.maxPxSize,
                    q = [],
                    n;
                c = 0;
                for (a = f.length; c < a; c++) n = f[c], q.push(this.getRadius(b, d, e, g, n));
                this.radii = q
            },
            getRadius: function(d,
                ...
                var g = this.options,
                    ...
                    q = g.zThreshold,
                    n = a - d;
                g.sizeByAbsoluteValue && null !== e && (e = Math.abs(e - q), n = Math.max(a - q, Math.abs(d - q)), d = 0);
                b(e) ? e < d ? c = c / 2 - 1 : (d = 0 < n ? (e - d) / n : .5, k && 0 <= d && (d = Math.sqrt(d)), c = Math.ceil(c + d * (f - c)) / 2) : c = null;
                return c
            },
            animate: function(b) {
                !b && this.points.length < this.options.animationLimit && (this.points.forEach(function(b) {
                        ...
                        d && d.width && (a = {
                            ...
                            width: 1,
                            height: 1
                        }), d.animate(a, this.options.animation))
                    },
            ...
            translate: function() {
                ...
                for (c = f.length; c--;) e = f[c], g = k ? k[c] : 0, b(g) && g >= this.minPxSize / 2 ? (e.marker = a.extend(e.marker, {
                    radius: g,
                    width: 2 * g,
                    height: 2 * g
                }), e.dlBox = {
        ...
        e.prototype.beforePadding = function() {
            var d = this,
                ...
                w = this.min,
                x = {},
                r = Math.min(g.plotWidth, g.plotHeight),
                B = Number.MAX_VALUE,
                y = -Number.MAX_VALUE,
                z = this.max - w,
                H = e / z,
            ...
            C.forEach(function(a) {
                ...
                m && a.getRadii(B, y, a);
                if (0 < z)
                    for (; e--;) b(c[e]) && d.dataMin <= c[e] && c[e] <= d.dataMax && (f = a.radii[e], h = Math.min((c[e] - w) * H - f, h), k = Math.max((c[e] - w) * H + f, k))
            });
            C.length && 0 < z && !this.isLog && (k -= e, H *= (e + Math.max(0,
                h) - Math.min(k, e)) / e, [
                ["min", "userMin", h],
                ["max", "userMax", k]
            ].forEach(function(b) {
                void 0 === f(d.options[b[0]], d[b[1]]) && (d[b[0]] += b[2] / H)
            }))
        }
    });
    y(r, "modules/networkgraph/integrations.js", [r["parts/Globals.js"]], function(a) {
        a.networkgraphIntegrations = {
            verlet: {
                attractiveForceFunction: function(a, l) {
                    return (l - a) / a
                },
                repulsiveForceFunction: function(a, l) {
                    return (l - a) / a * (l > a ? 1 : 0)
                },
                barycenter: function() {
                    var a = this.options.gravitationalConstant,
                        l = this.barycenter.xFactor,
                        e = this.barycenter.yFactor,
                        l = (l - (this.box.left +
                            this.box.width) / 2) * a,
                        e = (e - (this.box.top + this.box.height) / 2) * a;
                    this.nodes.forEach(function(a) {
                        a.fixedPosition || (a.plotX -= l / a.mass / a.degree, a.plotY -= e / a.mass / a.degree)
                    })
                },
                repulsive: function(a, l, e) {
                    l = l * this.diffTemperature / a.mass / a.degree;
                    a.fixedPosition || (a.plotX += e.x * l, a.plotY += e.y * l)
                },
                attractive: function(a, l, e) {
                    var h = a.getMass(),
                        b = -e.x * l * this.diffTemperature;
                ...
                integrate: function(a, l) {
                    var e = -a.options.friction,
                        h = a.options.maxSpeed,
                        b = (l.plotX + l.dispX - l.prevX) * e,
                        e = (l.plotY + l.dispY - l.prevY) * e,
                        g = Math.abs,
                        f = g(b) / (b || 1),
                        g = g(e) / (e || 1),
                        b = f * Math.min(h, Math.abs(b)),
                        e = g * Math.min(h, Math.abs(e));
                    l.prevX = l.plotX + l.dispX;
                    l.prevY = l.plotY + l.dispY;
                    l.plotX += b;
                    l.plotY += e;
                    l.temperature = a.vectorLength({
                        x: b,
                        y: e
                    })
                },
            ...
            euler: {
                ...
                repulsive: function(a, l, e, h) {
                    a.dispX += e.x / h * l / a.degree;
                    a.dispY += e.y / h * l / a.degree
                },
                attractive: function(a,
                    ...
                    var b = a.getMass(),
                        g = e.x / h * l;
                    l *= e.y / h;
                    a.fromNode.fixedPosition || (a.fromNode.dispX -= g * b.fromNode / a.fromNode.degree, a.fromNode.dispY -= l * b.fromNode / a.fromNode.degree);
                    a.toNode.fixedPosition || (a.toNode.dispX += g * b.toNode / a.toNode.degree, a.toNode.dispY += l * b.toNode / a.toNode.degree)
                },
                integrate: function(a, l) {
                    var e;
                    l.dispX += l.dispX * a.options.friction;
                    l.dispY += l.dispY * a.options.friction;
                    e = l.temperature = a.vectorLength({
                        x: l.dispX,
                        y: l.dispY
                    });
    ...
    y(r, "modules/networkgraph/QuadTree.js", [r["parts/Globals.js"]], function(a) {
        var p = a.QuadTreeNode = function(a) {
            this.box = a;
        ...
        a.extend(p.prototype, {
            ...
            updateMassAndCenter: function() {
                ...
                this.isInternal ? (this.nodes.forEach(function(e) {
                    e.isEmpty || (a += e.mass, h += e.plotX * e.mass, b += e.plotY * e.mass)
                }), h /= a, b /= a) : this.body && (a = this.body.mass, h = this.body.plotX, b = this.body.plotY);
                this.mass = a;
                this.plotX = h;
                this.plotY =
                    b
        ...
        var l = a.QuadTree = function(a, h, b, g) {
            this.box = {
                left: a,
                top: h,
                width: b,
        ...
        a.extend(l.prototype, {
            ...
            visitNodeRecursive: function(a, h, b, g, f) {
                var c;
                a || (a = this.root);
                a === this.root && h && (c = h(a));
                !1 !== c && (a.nodes.forEach(function(a) {
                    if (a.isInternal) {
                        h && (c = h(a));
                        if (!1 === c) return;
                        this.visitNodeRecursive(a,
                            h, b, g, f)
                    } else a.body && h && h(a.body);
                    b && b(a)
            ...
            render: function(a, h) {
                this.visitNodeRecursive(this.root, null, null, a, h)
            },
            clear: function(a) {
                this.render(a, !0)
            },
            renderBox: function(a, h, b) {
                a.graphic || b ? b && (a.graphic && (a.graphic = a.graphic.destroy()), a.graphic2 && (a.graphic2 = a.graphic2.destroy()), a.label && (a.label = a.label.destroy())) : (a.graphic = h.renderer.rect(a.box.left + h.plotLeft,
                    a.box.top + h.plotTop, a.box.width, a.box.height).attr({
                    stroke: "rgba(100, 100, 100, 0.5)",
                    "stroke-width": 2
                }).add(), isNaN(a.plotX) || (a.graphic2 = h.renderer.circle(a.plotX, a.plotY, a.mass / 10).attr({
                    fill: "red",
                    translateY: h.plotTop,
                    translateX: h.plotLeft
                }).add()))
            }
        })
    });
    y(r, "modules/networkgraph/layouts.js", [r["parts/Globals.js"]], function(a) {
        ...
        a.extend(a.layouts["reingold-fruchterman"].prototype, {
            ...
            step: function() {
                ...
                f.enableSimulation && (g.forEach(function(b) {
                    b.chart && b.render()
            ...
            removeNode: function(b) {
                b = this.nodes.indexOf(b); - 1 !== b && this.nodes.splice(b, 1)
            },
            removeLink: function(b) {
                b = this.links.indexOf(b); - 1 !== b && this.links.splice(b, 1)
            },
            addLinks: function(b) {
                b.forEach(function(b) {
                    -1 === this.links.indexOf(b) && this.links.push(b)
                }, this)
            },
            addSeries: function(b) {
                -1 === this.series.indexOf(b) && this.series.push(b)
            },
            clear: function() {
                this.nodes.length = 0;
                this.links.length = 0;
            ...
            setMaxIterations: function(b) {
                this.maxIterations = p(b, this.options.maxIterations)
            },
            ...
            setCircularPositions: function() {
                function b(a) {
                    a.linksFrom.forEach(function(a) {
                        l[a.toNode.id] || (l[a.toNode.id] = !0, h.push(a.toNode), b(a.toNode))
                    })
                }
                var a = this.box,
                    f = this.nodes,
                    c = 2 * Math.PI / (f.length + 1),
                ...
                h.length ? f.forEach(function(b) {
                    -1 === h.indexOf(b) && h.push(b)
                }) : h = f;
                h.forEach(function(b, f) {
                    b.plotX = b.prevX = p(b.plotX, a.width / 2 + d * Math.cos(f * c));
                    b.plotY = b.prevY = p(b.plotY, a.height / 2 + d * Math.sin(f * c));
                    b.dispX = 0;
                    b.dispY = 0
                })
            },
            setRandomPositions: function() {
                ...
                f.forEach(function(f, e) {
                    f.plotX = f.prevX = p(f.plotX, a.width * b(e));
                    f.plotY = f.prevY = p(f.plotY, a.height * b(c + e));
                    f.dispX = 0;
                    f.dispY = 0
                })
            },
            ...
            barnesHutApproximation: function(b,
                a) {
                var f = this.getDistXY(b, a),
                    c = this.vectorLength(f),
                    e, g;
                b !== a && 0 !== c && (a.isInternal ? a.boxSize / c < this.options.theta && 0 !== c ? (g = this.repulsiveForce(c, this.k), this.force("repulsive", b, g * a.mass, f, c), e = !1) : e = !0 : (g = this.repulsiveForce(c, this.k), this.force("repulsive", b, g * a.mass, f, c)));
                return e
            },
            repulsiveForces: function() {
                var b = this;
                "barnes-hut" === b.approximation ? b.nodes.forEach(function(a) {
                    b.quadTree.visitNodeRecursive(null, function(f) {
                        return b.barnesHutApproximation(a, f)
                    })
            ...
            attractiveForces: function() {
                ...
                b.links.forEach(function(e) {
                    e.fromNode && e.toNode && (a = b.getDistXY(e.fromNode, e.toNode), f = b.vectorLength(a), 0 !== f && (c = b.attractiveForce(f, b.k), b.force("attractive", e, c, a, f)))
                })
            },
            ...
            applyLimitBox: function(b, a) {
                var f = b.marker && b.marker.radius || 0;
                b.plotX = Math.max(Math.min(b.plotX, a.width - f), a.left + f);
                b.plotY = Math.max(Math.min(b.plotY, a.height - f), a.top + f)
            },
            coolDown: function(b, a, f) {
                return b - a * f
            },
            isStable: function() {
        ...
        e(h, "render", function() {
            function b(a) {
                a.maxIterations-- && isFinite(a.temperature) && !a.isStable() && !a.options.enableSimulation && (a.beforeStep && a.beforeStep(), a.step(), e = !1, f = !0)
            }
            var e, f = !1;
    ...
    y(r, "modules/networkgraph/draggable-nodes.js", [r["parts/Globals.js"]], function(a) {
        ...
        a.dragNodesMixin = {
            ...
            onMouseMove: function(a, h) {
                if (a.fixedPosition &&
                    a.inDragMode) {
                    var b = this.chart,
                        e = b.pointer.normalize(h);
                    h = a.fixedPosition.chartX - e.chartX;
                    e = a.fixedPosition.chartY - e.chartY;
                    if (5 < Math.abs(h) || 5 < Math.abs(e)) h = a.fixedPosition.plotX - h, e = a.fixedPosition.plotY - e, b.isInsidePlot(h, e) && (a.plotX = h, a.plotY = e, this.redrawHalo(a), this.layout.simulation ? this.layout.resetSimulation() : (this.layout.setInitialRendering(!1), this.layout.enableSimulation ? this.layout.start() : this.layout.setMaxIterations(1), this.chart.redraw(), this.layout.setInitialRendering(!0)))
                }
            },
        ...
        l(p, "load", function() {
            ...
            a.container && (h = l(a.container, "mousedown", function(f) {
                ...
                }), g = l(a.container.ownerDocument, "mouseup", function(a) {
                    b();
                    g();
    ...
    y(r, "parts-more/PackedBubbleSeries.js", [r["parts/Globals.js"]], function(a) {
        var p = a.seriesType,
            ...
            f = a.Chart,
            c = a.Color,
            t = a.layouts["reingold-fruchterman"],
            w = a.seriesTypes.bubble.prototype.pointClass,
            x = a.dragNodesMixin;
        a.networkgraphIntegrations.packedbubble = {
            repulsiveForceFunction: function(a,
                b, c, f) {
                return Math.min(a, (c.marker.radius + f.marker.radius) / 2)
            },
            barycenter: function() {
                var a = this,
                ...
                f.forEach(function(d) {
                    ...
                    d.fixedPosition || (d.plotX -= (d.plotX - e) * b / (d.mass * Math.sqrt(f.length)), d.plotY -= (d.plotY - k) * b / (d.mass * Math.sqrt(f.length)))
                })
            },
            repulsive: function(a, b, c, f) {
        ...
        a.layouts.packedbubble = a.extendClass(t, {
            ...
            setCircularPositions: function() {
                var a = this,
                    ...
                    g, k, m = a.options.initialPositionRadius;
            ...
            repulsiveForces: function() {
                var a = this,
                    b, c, f, e = a.options.bubblePadding;
            ...
            applyLimitBox: function(a) {
                var b, d;
                this.options.splitSeries && !a.isParentNode && this.options.parentNodeLimit && (b = this.getDistXY(a, a.series.parentNode), d = a.series.parentNodeRadius - a.marker.radius - this.vectorLength(b), 0 > d && d > -2 * a.marker.radius && (a.plotX -= .01 * b.x, a.plotY -= .01 * b.y));
                t.prototype.applyLimitBox.apply(this, arguments)
            },
            isStable: function() {
                return .00001 >
        ...
        p("packedbubble", "bubble", {
            ...
            accumulateAllPoints: function(a) {
                var b = a.chart,
                    d = [],
                    c, f;
                for (c = 0; c < b.series.length; c++)
                    if (a = b.series[c], a.visible || !b.options.chart.ignoreHiddenSeries)
                        for (f = 0; f < a.yData.length; f++) d.push([null, null, a.yData[f], a.index, f, {
                            id: f,
                            marker: {
                                radius: 0
                            }
            ...
            render: function() {
                ...
                this.data.forEach(function(d) {
                    a.isArray(d.dataLabels) && d.dataLabels.forEach(function(a) {
                        b.push(a)
                    })
                });
                this.chart.hideOverlappingLabels(b)
            },
            setVisible: function() {
                var a = this;
                ...
                a.parentNodeLayout && a.graph ? a.visible ? (a.graph.show(), a.parentNode.dataLabel && a.parentNode.dataLabel.show()) : (a.graph.hide(), a.parentNodeLayout.removeNode(a.parentNode), a.parentNode.dataLabel &&
                    a.parentNode.dataLabel.hide()) : a.layout && (a.visible ? a.layout.addNodes(a.points) : a.points.forEach(function(b) {
            ...
            calculateParentRadius: function() {
                var a;
                this.group && (a = this.group.element.getBBox());
            ...
            drawGraph: function() {
                if (this.layout && this.layout.options.splitSeries) {
                    var b = this.chart,
                        f, e = this.layout.options.parentNodeOptions.marker,
                        e = {
                    ...
                    this.parentNodesGroup || (this.parentNodesGroup = this.plotGroup("parentNodesGroup", "parentNode", f, .1, b.seriesGroup), this.group.attr({
                        zIndex: 2
                    }));
            ...
            addLayout: function() {
                ...
                g = c[b.type];
                g || (b.enableSimulation = h(e.forExport) ? !e.forExport : b.enableSimulation, c[b.type] = g = new a.layouts[b.type], g.init(b), f.splice(g.index, 0,
                    g));
                this.layout = g;
            ...
            translate: function() {
                ...
                for (m = 0; m < k.length; m++) k[m][3] === f && (e = c[k[m][4]], g = k[m][2], l || (e.plotX = k[m][0] - b.plotLeft + b.diffX, e.plotY = k[m][1] - b.plotTop + b.diffY), e.marker = a.extend(e.marker, {
                    radius: g,
                    width: 2 * g,
                    height: 2 * g
                }));
            ...
            placeBubbles: function(a) {
                ...
                if (1 === a.length) h = [0, 0, a[0][0], a[0][1], a[0][2]];
                else if (a.length) {
                    c.push([
                    ...
                    for (l = 2; l < a.length; l++) a[l][2] = a[l][2] || 1, h = d(c[f][e], c[f - 1][g], a[l]), b(h, c[f][0]) ? (c.push([]), g = 0, c[f + 1].push(d(c[f][e], c[f][0], a[l])), f++, e = 0) : 1 < f && c[f - 1][g + 1] && b(h, c[f - 1][g + 1]) ? (g++, c[f].push(d(c[f][e], c[f - 1][g], a[l])), e++) : (e++, c[f].push(h));
                    this.chart.stages = c;
            ...
            resizeRadius: function() {
                ...
                for (z = 0; z < b.length; z++) r = b[z][2], t = c(t, b[z][0] - r), p = f(p, b[z][0] + r), x = c(x, b[z][1] - r), w = f(w, b[z][1] + r);
                z = [p - t, w - x];
                c = c.apply([], [(l - e) / z[0], (h - g) / z[1]]);
                if (1e-10 < Math.abs(c - 1)) {
                    for (z = 0; z < b.length; z++) b[z][2] *= c;
                    this.placeBubbles(b)
                } else a.diffY = h / 2 + g - x - (w - x) / 2, a.diffX = l / 2 + e - t - (p - t) / 2
            },
            ...
            getPointRadius: function() {
                ...
                ["minSize", "maxSize"].forEach(function(a) {
                    var b = parseInt(c[a], 10),
                        d = /%$/.test(c[a]);
                    g[a] = d ? e * b / 100 : b * Math.sqrt(l.length)
                });
                ...
                (l || []).forEach(function(b, c) {
                    x = f ? Math.max(Math.min(b[2], r[1]), r[0]) : b[2];
                    w = a.getRadius(r[0], r[1], t, p, x);
                    0 === w && (w = null);
                    l[c][2] = w;
                    h.push(w)
                });
            ...
            onMouseUp: function(b) {
                if (b.fixedPosition && !b.removed) {
                    ...
                    e && f.options.dragBetweenSeries && e.nodes.forEach(function(e) {
                        b && b.marker && e !==
                            b.series.parentNode && (c = f.getDistXY(b, e), d = f.vectorLength(c) - e.marker.radius - b.marker.radius, 0 > d && (e.series.addPoint(a.merge(b.options, {
                                plotX: b.plotX,
                                plotY: b.plotY
    ...
    y(r, "parts-more/Polar.js", [r["parts/Globals.js"]], function(a) {
        ...
        e.spline && (h(e.spline.prototype, "getPointSpline", function(a, b, e, g) {
            ...
            return a
        }), e.areasplinerange && (e.areasplinerange.prototype.getPointSpline = e.spline.prototype.getPointSpline));
        a.addEvent(l, "afterTranslate", function() {
            ...
            if (b.polar) {
                ...
                if (!this.preventPostTranslate)
                    for (c = this.points, e = c.length; e--;) this.toXY(c[e]), !b.hasParallelCoordinates && !this.yAxis.reversed && c[e].y < this.yAxis.min && (c[e].isNull = !0);
        ...
        l = function(a, b) {
            ...
            c.polar ? c.renderer.isSVG && (!0 === f && (f = {}), b ? (a = {
                ...
                scaleX: .001,
                scaleY: .001
            }, e.attr(a), d && d.attr(a)) : (a = {
                translateX: h,
                translateY: l,
                scaleX: 1,
                scaleY: 1
            }, e.animate(a, f), d && d.animate(a, f), this.animate = null)) : a.call(this, b)
        };
        h(b, "animate", l);
        e.column && (e = e.column.prototype, e.polarArc = function(a, b, e, g) {
            var c = this.xAxis.center,
                d = this.yAxis.len;
            return this.chart.renderer.symbols.arc(c[0], c[1], d - b, null, {
                start: e,
                end: g,
                innerR: d - p(a, d)
            })
        }, h(e, "animate", l), h(e, "translate",
            function(a) {
                var b = this.xAxis,
                    f = b.startAngleRad,
                    e, g, d;
                ...
                a.call(this);
                if (b.isRadial)
                    for (e = this.points, d = e.length; d--;) g = e[d], a = g.barX + f, g.shapeType = "path", g.shapeArgs = {
        ...
        h(g, "getCoordinates", function(a, b) {
            var c = this.chart,
                e = {
                    xAxis: [],
                    yAxis: []
